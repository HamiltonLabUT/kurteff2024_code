...
figure_dfs = [pd.read_csv(os.path.join(git_path,"figures","figure_2","csv","figure_2_cmap_spkr.csv")),
              pd.read_csv(os.path.join(git_path,"figures","figure_2","csv","figure_2_cmap_mic.csv")),
              pd.read_csv(os.path.join(git_path,"figures","figure_2","csv","figure_2_cmap_dual_onset.csv"))]

...
# 3. Applies a common average reference to the data
...
annot_fname = os.path.join(data_path,f"sub-{subj}",blockid,"Raw","ecog_raw_annotated.fif")
...
input("Press Enter to apply a common average reference to the data...")
raw.set_eeg_reference(raw.info['ch_names'])
...
raw.save(annot_fname, overwrite=True)